...
//class fake dari NewsDao
class FakeNewsDao: NewsDao {
    //karena hanya kelas fake pengimplementasian db bisa diganti dengan list
    ...
    override suspend fun deleteNews(newsTitle: String) {
        //menghapus jika title terdapat pada list
    ...
    override fun isNewsBookmarked(title: String): LiveData<Boolean> {
        ...
        //any untuk mengetahui suatu data atau tidak
