...
/*
Scenario:
a. Menampilkan berita
Memastikan RecyclerView untuk data headline news telah ditampilkan.

b. Menampilkan detail berita
Memastikan menuju ke halaman NewsDetailActivity.
Memastikan halaman detail menampilkan WebView.

c. Menyimpan bookmark
Memastikan ketika menyimpan bookmark melalui detail muncul di tab Bookmark.
Memastikan detail bookmark dapat menampilkan WebView.
* */
...
class HomeActivityTest{
    ...
    //menampilkan activity secara langsung
    @get:Rule
    ...
    fun loadHeadlineNews_Success() {
        ...
        //pengecekan dengan aksi scrolling
    ...
    fun loadDetailNews_Success() {
        ...
        //validasi apakah intent sudah benar atau tidak
