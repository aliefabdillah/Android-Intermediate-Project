...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation(){
        ...
        val messageTV = setOtherViewAnimation(binding.messageTextView)
        val emailTV = setOtherViewAnimation(binding.emailTextView)
        val emailET = setOtherViewAnimation(binding.emailEditTextLayout)
        val passTV = setOtherViewAnimation(binding.passwordTextView)
        val passET = setOtherViewAnimation(binding.passwordEditTextLayout)
        val loginBtn = setOtherViewAnimation(binding.loginButton)

        AnimatorSet().apply {
            playSequentially(titleTV, messageTV, emailTV, emailET, passTV, passET, loginBtn)
            start()
        }
    }
