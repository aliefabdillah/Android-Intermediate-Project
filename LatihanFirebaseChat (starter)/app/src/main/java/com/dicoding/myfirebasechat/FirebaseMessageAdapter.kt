...
//class untuk membuat custom recycler view dari firebase
    ...
    inner class MessageViewHolder(private val binding: ItemMessageBinding) :
        ...
        fun bind(item: Message) {
            ...
            if (item.timeStamp != null) {
                //menambahkan waktu chat dikirimkan
                //getRelativeTimeSpan digunakan untuk menghasilkan data waktu yang telahlama berlalu
                binding.tvTimestamp.text = DateUtils.getRelativeTimeSpanString(item.timeStamp)
            }
        }

        //mengatur warna text chat sesuai useryang login
        private fun setTextColor(userName: String?, textView: TextView) {
            //jika currentUsername merupakan akun kita maka akan berwarana biru
